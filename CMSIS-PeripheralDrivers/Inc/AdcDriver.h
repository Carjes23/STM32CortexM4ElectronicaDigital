...
#define EXTEN_DISABLE			0
#define EXTEN_RISING_TIMER5_CC1 1
#define EXTEN_RISING_TIMER5_CC2 2
#define EXTEN_RISING_TIMER4_CC4 3
...
typedef struct
{
	uint8_t* 	channels;			// Canal ADC que será utilizado para la conversión ADC SINGLE
	...
	uint8_t		numberOfChannels;	//Cantidad de canales
	uint8_t		externType; 		//Que tipo de funcion externa
}ADC_Config_t;
