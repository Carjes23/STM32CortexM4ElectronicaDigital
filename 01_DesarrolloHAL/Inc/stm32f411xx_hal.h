...
typedef struct
{
	...
	volatile uint32_t OTYPE; //ADDR_OFSET: anterior +4
...
//Valores estandar para ls configuracioenes
...
//8.4.2 GPIOx OTYPER (un bit por cada pin)
...
//	Definicion demlos nombre de los pines
#define PIN_0			0
#define PIN_1			1
#define PIN_2			2
#define PIN_3			3
